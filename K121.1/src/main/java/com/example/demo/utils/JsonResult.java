...
public class JsonResult {
	...
	public String toString() {
		return "JsonResult [object=" + object + ", object2=" + object2 + ", object3=" + object3 + ", objs=" + objs
				+ ", objs2=" + objs2 + ", objs3=" + objs3 + ", objs4=" + objs4 + ", objs5=" + objs5 + ", res1=" + res1
				+ ", res2=" + res2 + ", res3=" + res3 + ", allprice=" + allprice + ", imgs=" + Arrays.toString(imgs)
				+ ", stringvalue=" + Arrays.toString(stringvalue) + ", stringvalue1=" + Arrays.toString(stringvalue1)
				+ ", resInteger=" + resInteger + ", resInteger1=" + resInteger1 + ", zhifu1=" + zhifu1 + ", zhifu2="
				+ zhifu2 + ", zhifu3=" + zhifu3 + ", zhifu4=" + zhifu4 + ", zhifu5=" + zhifu5 + "]";
	}
