...
public class FileUploadTool {
  ...
  public FileEntity createFile(MultipartFile multipartFile, HttpServletRequest request) {
    ...
    if (bflag) {
      String logoPathDir = "/videos/";
//      String logoRealPathDir = request.getSession().getServletContext().getRealPath(logoPathDir);
      // 上传到本地磁盘
      String logoRealPathDir = "c:/videos";
      ...
      String finalFileDir = logoPathDir + newFileName + fileEnd;
      // size存储为String
      ...
      if (aviPath != null) {
        ...
        if (this.checkMediaType(fileEnd)) {
          try {
            ...
            finalFileDir = logoPathDir + newFileName + ".flv";
            System.out.println("path:"+finalFileDir);
          } catch (Exception e) {
            e.printStackTrace();
          }
        }
