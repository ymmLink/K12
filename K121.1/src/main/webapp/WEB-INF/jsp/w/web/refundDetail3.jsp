...
<title>退款详情已经完成</title>
	<link href="/static/css/refundDetail3.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<header>
		...
		<div class="refundDetail_div">
			<div class="detail_jindu">
				...
				<div class="detail_jindu_div">
					...
					<div class="detail_jindu_div_img"><img alt="" src="../static/images/detail/pic12.png" style="width: calc(40px * 1);height: calc(40px * 1);"></div>
			...
			<div class="refundDetail_buttom">
				...
				<div class="refunDetail_buttom_div_top">
					...
					<div class="refundDetail_buttom_text">
						...
						<div class="text">退款金额会根据商品的具体情况而定，如有疑问请联系客服</div>
					</div>
					<div class="refundDetail_buttom_text">
						<div class="label">未同意原因</div>
						<div class="text">${refurnds[0].disagreeReason}</div>
					</div>
				...
				<div class="refunDetail_buttom_div_top">
					...
					<!-- <div class="refundDetail_buttom_text">
						...
						<div class="text">2019-07-02 14:52:12</div>
					</div> -->
				</div>
			</div>
