...
<meta charset="UTF-8">
<title>待评价详情</title>
	<link href="/static/css/detail4.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<header>
		...
		<div class="detail_div">
			<div class="detail_jindu">
				...
				<div class="detail_jindu_div">
					...
					<div class="detail_jindu_div_img"><img alt="" src="../static/images/detail/pic1.png" style="width: calc(40px * 1);height: calc(40px * 1);"></div>
					<div class="detail_jindu_div_time">${details[0].deliverDate }</div>
				</div>
				<div class="line3"></div>
				<div class="detail_jindu_div">
					<div class="detail_jindu_div_title">确认收货</div>
					<div class="detail_jindu_div_img"><img alt="" src="../static/images/detail/pic1.png" style="width: calc(40px * 1);height: calc(40px * 1);"></div>
					<div class="detail_jindu_div_time">${details[0].receiveDate }</div>
				</div>
				<div class="line4"></div>
				<div class="detail_jindu_div">
			...
			<div class="detail_wuliuInfo">
				<div class="detail_wuliuInfo_title">
					...
					<div class="detail_wuliuInfo_title_button">已签收</div>
				</div>
				...
				<div class="detail_wuliuInfo_context">
					...
					<div class="detail_wuliuInfo_context_mode">
						...
						<div class="mode_text">${details[0].deliverModel }</div>
					</div>
					<div class="detail_wuliuInfo_context_num">
						<div class="num">运单号码：</div>
						<div class="num_text">${details[0].logisticCode }</div>
					</div>
				</div>
				<div class="detail_wuliuInfo_line"></div>
				...
				<div class="cart_div">
					...
					<div class="order_info">
						...
						<div class="order_info_div">
							...
							<div class="order_info_div_time" style="margin-right: 136px;">${details[0].deliverDate}</div>
						</div>
						<div class="order_info_div">
							<div class="order_info_div_top">成交时间：</div>
							<div class="order_info_div_time">${details[0].receiveDate}</div>
						</div>
					</div>
					<div class="cart_line"></div>
					<div class="cart_img">
