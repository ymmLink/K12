...
<body>
	...
	<div>
		<input type="button" class="btn btn-primary-outline radius" value="添加管理员" style="margin:20px" onclick="goAddAdmin()">
	</div>
	<div class="codeView " >
      <form action="saveUser.action" method="post" class="form form-horizontal responsive" id="demoform">
        <div class="row clearfix">
          <label class="form-label col-xs-3">账号：</label>
          <div class="formControls col-xs-8">
            <input type="text" class="input-text" placeholder="账号" readonly="readonly" name="account" id="account" value="${admin.account }">
          </div>
        </div>
        ...
        <div class="row clearfix">
          ...
          <div class="formControls col-xs-8">
            <input type="text" class="input-text" placeholder="请输入名字"  name="name" id="name"   value="${admin.name }">
          </div>
        </div>
        <div class="row clearfix">
          <label class="form-label col-xs-3">手机：</label>
          <div class="formControls col-xs-8">
            <input type="text" class="input-text" autocomplete="off" placeholder="手机" name="phone" id="phone" value="${admin.phone }">
          </div>
        </div>
        <div class="row clearfix">
            ...
            <div class="field" id="s1" >
				<div id="qxscan0" class="fieldpicqx">
					<div class="" onclick="selectImg(this)" style="height:100px;width:100px;padding:0px;border:0px;">
						<img style="width:100%;height:100%" src="${admin.img }">
					</div>
        ...
        <div class="row clearfix">
          <div class="col-xs-8 col-xs-offset-3">
            <input class="btn btn-primary" type="button" value="修改" data-state="0" onclick="saveChange(this)">
          </div>
        </div>
      </form>
    </div>
...
<script type="text/javascript">
	...
	function goAddAdmin(){
		window.href.location="addAdminPage";
	}
</script>
</html>